...
| Page links | Topics (tools using Python coding are ready to use|
|--|--|
| ↪️ [**NLP**](/res/nlt_tools.md) | Corpus, Text processing, word frequency, POS tagging, etc.|
| ↪️ [**SP**](/res/sp_tools.md)  | Speech processing, Text-to-Speech, Pronunciation, etc.|
| ↪️ [**Stats**](/res/stats1.md) | Basic statistics with R and Python, bar graph, scatter plot, etc. |
